...
FOSSIL_TEST_GROUP(objc_sanity_test_cases) {
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_execute);
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_getpid);
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_create_file);
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_file_exists);
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_create_dir);
    FOSSIL_SUITE_ADD(objc_sanity_suite, objc_sanity_sys_dir_exists);
