...
FOSSIL_TEST_GROUP(c_bdd_test_cases) {
    FOSSIL_ADD_TEST(bdd_suite, xbdd_logic_test);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_user_account);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_empty_cart);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_valid_login);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_invalid_login);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_insufficient_balance);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_add_multiple_items_to_cart);
    FOSSIL_ADD_TEST(bdd_suite, xbdd_remove_item_from_cart);

    FOSSIL_ADD_SUITE(bdd_suite);
} // end of group
