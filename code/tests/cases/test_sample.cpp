...
FOSSIL_TEST_GROUP(cpp_sample_test_cases) {
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_increment);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_decrement);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_double);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_half);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_modulo);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_square);
    FOSSIL_SUITE_ADD(cpp_sample_suite, cpp_test_input_equal);
