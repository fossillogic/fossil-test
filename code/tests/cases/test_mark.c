...
FOSSIL_TEST_CASE(c_mark_elapsed_time) {
    fossil_benchmark_t benchmark;
...
FOSSIL_TEST_GROUP(c_mark_test_cases) {
    ...
    FOSSIL_TEST_ADD(c_mark_suite, c_mark_init);
    ...
    FOSSIL_TEST_ADD(c_mark_suite, c_mark_reset);
