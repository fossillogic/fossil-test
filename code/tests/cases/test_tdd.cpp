...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int) {
    int x = 42;
    int y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int8) {
    int8_t x = 42;
    int8_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int16) {
    int16_t x = 42;
    int16_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int32) {
    int32_t x = 42;
    int32_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int64) {
    int64_t x = 42;
    int64_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int8_shortcut) {
    int8_t x = 42;
    int8_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int16_shortcut) {
    int16_t x = 42;
    int16_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int32_shortcut) {
    int32_t x = 42;
    int32_t y = 20;
...
FOSSIL_TEST_CASE(cpp_xassume_run_of_int64_shortcut) {
    int64_t x = 42;
    int64_t y = 20;
...
FOSSIL_TEST_GROUP(cpp_tdd_test_cases) {
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int8);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int16);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int32);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int64);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int8_shortcut);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int16_shortcut);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int32_shortcut);
    FOSSIL_TEST_ADD(cpp_tdd_suite, cpp_xassume_run_of_int64_shortcut);
