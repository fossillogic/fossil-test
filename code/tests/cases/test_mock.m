...
FOSSIL_TEST(objc_mock_function_creation) {
    // Test cases
    FOSSIL_TEST_ASSUME(fossil_mockup_objc_mock_function(2, 3) == 5, "Mock function should return the sum of its arguments");
} // end case
...
FOSSIL_TEST(objc_mock_io_capture_output) {
    ...
    int captured_size = fossil_mock_capture_output(buffer, sizeof(buffer), fossil_mockup_objc_mock_function_with_output);
