...
FOSSIL_TEST(objcpp_mock_function_creation) {
    // Test cases
    FOSSIL_TEST_ASSUME(fossil_mockup_objcpp_mock_function(2, 3) == 5, "Mock function should return the sum of its arguments");
} // end case
...
FOSSIL_TEST(objcpp_mock_io_capture_output) {
    ...
    int captured_size = fossil_mock_capture_output(buffer, sizeof(buffer), fossil_mockup_objcpp_mock_function_with_output);
...
FOSSIL_TEST(objcpp_mock_io_redirect_stdout_macro) {
    ...
    FOSSIL_MOCK_REDIRECT_STDOUT(buffer, sizeof(buffer), fossil_mockup_objcpp_mock_function_redirection);
