...
FOSSIL_TEST_GROUP(objcpp_bdd_test_cases) {
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_logic_test);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_user_account);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_empty_cart);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_valid_login);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_invalid_login);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_insufficient_balance);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_add_multiple_items_to_cart);
    FOSSIL_ADD_TEST(objcpp_bdd_suite, objcpp_xbdd_remove_item_from_cart);

    FOSSIL_ADD_SUITE(objcpp_bdd_suite);
} // end of group
