...
FOSSIL_SUITE(objcpp_bdd_suite);

// Setup function for the test suite
FOSSIL_SETUP(objcpp_bdd_suite) {
    // Setup code here
}

// Teardown function for the test suite
FOSSIL_TEARDOWN(objcpp_bdd_suite) {
    // Teardown code here
}
...
FOSSIL_TEST(objcpp_xbdd_logic_test) {
...
FOSSIL_TEST(objcpp_xbdd_user_account) {
...
FOSSIL_TEST(objcpp_xbdd_empty_cart) {
...
FOSSIL_TEST(objcpp_xbdd_valid_login) {
...
FOSSIL_TEST(objcpp_xbdd_invalid_login) {
    GIVEN("a registered user with valid credentials") {
        // Set up the context
        std::string validUsername = "user123";
        std::string validPassword = "pass456";
...
FOSSIL_TEST(objcpp_xbdd_insufficient_balance) {
...
FOSSIL_TEST(objcpp_xbdd_add_multiple_items_to_cart) {
    GIVEN("a user with an empty shopping cart") {
        // Set up the context
        int cartItemCount = 0;
...
FOSSIL_TEST(objcpp_xbdd_remove_item_from_cart) {
...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(objcpp_bdd_test_cases) {
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_logic_test);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_user_account);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_empty_cart);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_valid_login);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_invalid_login);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_insufficient_balance);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_add_multiple_items_to_cart);
    FOSSIL_SUITE_ADD(objcpp_bdd_suite, objcpp_xbdd_remove_item_from_cart);

    FOSSIL_TEST_REGISTER(objcpp_bdd_suite);
} // end of group
