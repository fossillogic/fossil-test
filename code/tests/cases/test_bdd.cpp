...
FOSSIL_TEST_GROUP(cpp_bdd_test_cases) {
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_logic_test);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_user_account);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_empty_cart);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_valid_login);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_invalid_login);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_insufficient_balance);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_add_multiple_items_to_cart);
    FOSSIL_ADD_TEST(cpp_bdd_suite, cpp_xbdd_remove_item_from_cart);

    FOSSIL_ADD_SUITE(cpp_bdd_suite);
} // end of group
