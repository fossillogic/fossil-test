 ...
 */
 ...
 FOSSIL_SUITE(objc_mark_suite);
 
 // Setup function for the test suite
 FOSSIL_SETUP(objc_mark_suite) {
     // Setup code here
 }
 
 // Teardown function for the test suite
 FOSSIL_TEARDOWN(objc_mark_suite) {
     // Teardown code here
 }
 ...
 FOSSIL_TEST(objc_mark_start_and_stop) {
 ...
 FOSSIL_TEST(objc_mark_multiple_benchmarks) {
 ...
 FOSSIL_TEST(objc_mark_elapsed_time) {
 ...
 FOSSIL_TEST(objc_mark_nested_benchmarks) {
 ...
 FOSSIL_TEST(objc_mark_reset_benchmark) {
 ...
 FOSSIL_TEST_GROUP(objc_mark_test_cases) {
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_start_and_stop);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_benchmark);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_start);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_stop);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_multiple_benchmarks);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_elapsed_time);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_invalid_benchmark_name);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_stop_without_start);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_nested_benchmarks);
     FOSSIL_TEST_ADD(objc_mark_suite, objc_mark_reset_benchmark);
