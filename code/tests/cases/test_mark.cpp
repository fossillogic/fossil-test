...
FOSSIL_TEST_CASE(cpp_mark_report) {
...
FOSSIL_TEST_CASE(cpp_mark_scoped_benchmark) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_minutes) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_seconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_milliseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_microseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_nanoseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_picoseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_femtoseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_attoseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_zeptoseconds) {
...
FOSSIL_TEST_CASE(cpp_mark_duration_yoctoseconds) {
...
FOSSIL_TEST_GROUP(cpp_mark_test_cases) {
    ...
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_report);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_scoped_benchmark);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_minutes);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_seconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_milliseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_microseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_nanoseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_picoseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_femtoseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_attoseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_zeptoseconds);
    FOSSIL_TEST_ADD(cpp_mark_suite, cpp_mark_duration_yoctoseconds);
