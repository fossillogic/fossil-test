...
==============================================================================
*/
#include <fossil/xassert/string.h> // library under test
...
XTEST(test_wstr_equal_success) {
    ...
    ASSERT_ITS_EQUAL_WSTR(actual, expected);
}
...
XTEST(test_wstr_not_equal_success) {
    ...
    ASSERT_NOT_EQUAL_WSTR(actual, expected);
}
...
XTEST(test_wstr_length_equal_success) {
    ...
    ASSERT_ITS_LENGTH_EQUAL_WSTR(str, expected_len);
}
...
XTEST(test_bstr_equal_success) {
    ...
    ASSERT_ITS_EQUAL_BSTR(actual, expected);
}
...
XTEST(test_bstr_not_equal_success) {
    ...
    ASSERT_NOT_EQUAL_BSTR(actual, expected);
}
...
XTEST(test_bstr_length_equal_success) {
    ...
    const size_t expected_len = 5;
    ASSERT_ITS_LENGTH_EQUAL_BSTR(str, expected_len);
}
...
XTEST(test_cstr_equal_success) {
    ...
    ASSERT_ITS_EQUAL_CSTR(actual, expected);
}
...
XTEST(test_cstr_not_equal_success) {
    ...
    ASSERT_NOT_EQUAL_CSTR(actual, expected);
}
...
XTEST(test_cstr_length_equal_success) {
    ...
    const size_t expected_len = 5;
    ASSERT_ITS_LENGTH_EQUAL_CSTR(str, expected_len);
}
...
XTEST_DEFINE_POOL(string_asserts_assert_group) {
